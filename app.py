...
app.title = "Market Valuation Analytics :smile:"
server = app.server
    ...
    children=[
        html.Div([
            html.Div([
                ...
                html.Div("👨🏿‍🔬 Gary Masawi with 🌻",
                         style={'margin-top': '20px', 'padding-top': '10px',
                                'border-top': '1px solid #ffeedd'}),
                html.Div(("Data is obtained through package FundamentalAnalysis "
                ...
                html.A(html.Img(src='assets/GitHub-Mark-Light-32px.png',
                       ...
                       href="http://hugo.garikai32.vercel.app/",
                       target="_blank"),
                html.A(html.Img(src='assets/linkedin-3-32.png',
                                style={"padding": "10px"}),
                       href="https://www.linkedin.com/in/gmasawi",
                       target="_blank"),
                html.A(html.Img(src='assets/Gmail-icon.png',
                                style={"padding": "10px"}),
                       href="https://mail.google.com/?view=cm&fs=1&to=Gary.masawi@gmail.com",
                       target="_blank")
